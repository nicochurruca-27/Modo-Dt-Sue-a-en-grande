...
const CLUB_TEMPLATES = [
  ...
  { id: 'boca', name: 'Boca Juniors', division: 'D1', zone: 'A', reputation: 5 },
  { id: 'river', name: 'River Plate', division: 'D1', zone: 'A', reputation: 5 },
  { id: 'racing', name: 'Racing Club', division: 'D1', zone: 'A', reputation: 4 },
  { id: 'sanlorenzo', name: 'San Lorenzo', division: 'D1', zone: 'A', reputation: 4 },
  ...
  { id: 'gimnasialp', name: 'Gimnasia y Esgrima La Plata', division: 'D1', zone: 'A', reputation: 3 },
  { id: 'argentinos', name: 'Argentinos Juniors', division: 'D1', zone: 'A', reputation: 3 },
  { id: 'huracan', name: 'Huracán', division: 'D1', zone: 'A', reputation: 3 },
  { id: 'banfield', name: 'Banfield', division: 'D1', zone: 'A', reputation: 3 },
  { id: 'tigre', name: 'Tigre', division: 'D1', zone: 'A', reputation: 3 },
  { id: 'platense', name: 'Platense', division: 'D1', zone: 'A', reputation: 2 },
  { id: 'barracascentral', name: 'Barracas Central', division: 'D1', zone: 'A', reputation: 2 },
  { id: 'riestra', name: 'Deportivo Riestra', division: 'D1', zone: 'A', reputation: 2 },
  { id: 'independienterivadavia', name: 'Independiente Rivadavia', division: 'D1', zone: 'A', reputation: 2 },

  // ---- Primera División — Zona B (15 equipos) ----
  { id: 'independiente', name: 'Independiente', division: 'D1', zone: 'B', reputation: 4 },
  { id: 'talleres', name: 'Talleres', division: 'D1', zone: 'B', reputation: 4 },
  { id: 'belgrano', name: 'Belgrano', division: 'D1', zone: 'B', reputation: 3 },
  { id: 'instituto', name: 'Instituto', division: 'D1', zone: 'B', reputation: 3 },
  { id: 'newells', name: "Newell's Old Boys", division: 'D1', zone: 'B', reputation: 4 },
  { id: 'rosariocentral', name: 'Rosario Central', division: 'D1', zone: 'B', reputation: 4 },
  { id: 'union', name: 'Unión', division: 'D1', zone: 'B', reputation: 3 },
  { id: 'colon', name: 'Colón', division: 'D1', zone: 'B', reputation: 3 },
  { id: 'lanus', name: 'Lanús', division: 'D1', zone: 'B', reputation: 3 },
  { id: 'defensayjusticia', name: 'Defensa y Justicia', division: 'D1', zone: 'B', reputation: 3 },
  { id: 'sarmientojunin', name: 'Sarmiento de Junín', division: 'D1', zone: 'B', reputation: 2 },
  { id: 'centralcordoba', name: 'Central Córdoba (SdE)', division: 'D1', zone: 'B', reputation: 2 },
  { id: 'godoycruz', name: 'Godoy Cruz', division: 'D1', zone: 'B', reputation: 3 },
  { id: 'atleticotucuman', name: 'Atlético Tucumán', division: 'D1', zone: 'B', reputation: 3 },
  { id: 'sanmartinsj', name: 'San Martín de San Juan', division: 'D1', zone: 'B', reputation: 2 },

  // ---- Primera Nacional — Zona A (18 equipos) ----
  { id: 'chacarita', name: 'Chacarita Juniors', division: 'D2', zone: 'A', reputation: 3 },
  { id: 'allboys', name: 'All Boys', division: 'D2', zone: 'A', reputation: 2 },
  { id: 'almagro', name: 'Almagro', division: 'D2', zone: 'A', reputation: 2 },
  ...
  { id: 'guillermobrown', name: 'Guillermo Brown', division: 'D2', zone: 'A', reputation: 2 },
  { id: 'losandes', name: 'Los Andes', division: 'D2', zone: 'A', reputation: 1 },
  { id: 'nuevachicago', name: 'Nueva Chicago', division: 'D2', zone: 'A', reputation: 2 },
  { id: 'quilmes', name: 'Quilmes', division: 'D2', zone: 'A', reputation: 3 },
  { id: 'temperley', name: 'Temperley', division: 'D2', zone: 'A', reputation: 2 },
  { id: 'tristansuarez', name: 'Tristán Suárez', division: 'D2', zone: 'A', reputation: 1 },
  { id: 'alvarado', name: 'Alvarado', division: 'D2', zone: 'A', reputation: 2 },
  { id: 'atleticorafaela', name: 'Atlético de Rafaela', division: 'D2', zone: 'A', reputation: 3 },
  { id: 'brownadrogue', name: 'Brown de Adrogué', division: 'D2', zone: 'A', reputation: 1 },
  { id: 'deportivoespanol', name: 'Deportivo Español', division: 'D2', zone: 'A', reputation: 1 },
  { id: 'colegiales', name: 'Colegiales', division: 'D2', zone: 'A', reputation: 1 },
  { id: 'villadalmine', name: 'Villa Dálmine', division: 'D2', zone: 'A', reputation: 2 },

  // ---- Primera Nacional — Zona B (18 equipos) ----
  { id: 'aldosivi', name: 'Aldosivi', division: 'D2', zone: 'B', reputation: 3 },
  { id: 'chacoforever', name: 'Chaco For Ever', division: 'D2', zone: 'B', reputation: 1 },
  { id: 'maipu', name: 'Deportivo Maipú', division: 'D2', zone: 'B', reputation: 2 },
  { id: 'moron', name: 'Deportivo Morón', division: 'D2', zone: 'B', reputation: 2 },
  { id: 'riocuarto', name: 'Estudiantes de Río Cuarto', division: 'D2', zone: 'B', reputation: 1 },
  { id: 'gimnasiaytiro', name: 'Gimnasia y Tiro', division: 'D2', zone: 'B', reputation: 1 },
  { id: 'racingcordoba', name: 'Racing de Córdoba', division: 'D2', zone: 'B', reputation: 1 },
  { id: 'santelmo', name: 'San Telmo', division: 'D2', zone: 'B', reputation: 2 },
  { id: 'almirantebrown', name: 'Almirante Brown', division: 'D2', zone: 'B', reputation: 2 },
  { id: 'defensoresbelgrano', name: 'Defensores de Belgrano', division: 'D2', zone: 'B', reputation: 2 },
  { id: 'mitresgo', name: 'Mitre de Santiago del Estero', division: 'D2', zone: 'B', reputation: 2 },
  { id: 'sanmartintuc', name: 'San Martín de Tucumán', division: 'D2', zone: 'B', reputation: 2 },
  { id: 'gimnasiamendoza', name: 'Gimnasia y Esgrima de Mendoza', division: 'D2', zone: 'B', reputation: 2 },
  { id: 'talleresremedios', name: 'Talleres de Remedios de Escalada', division: 'D2', zone: 'B', reputation: 1 },
  { id: 'sportivoestudiantes', name: 'Sportivo Estudiantes', division: 'D2', zone: 'B', reputation: 1 },
  { id: 'guemessgo', name: 'Güemes de Santiago del Estero', division: 'D2', zone: 'B', reputation: 1 },
  { id: 'centralnorte', name: 'Central Norte (Salta)', division: 'D2', zone: 'B', reputation: 1 },
  { id: 'camioneros', name: 'Deportivo Camioneros', division: 'D2', zone: 'B', reputation: 1 },
];
